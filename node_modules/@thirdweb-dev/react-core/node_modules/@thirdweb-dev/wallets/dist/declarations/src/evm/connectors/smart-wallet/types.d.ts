...
import type { ChainOrRpcUrl, SmartContract, Transaction } from "@thirdweb-dev/sdk";
import type { BigNumber, BigNumberish, ContractInterface, Signer } from "ethers";
...
export interface AccountApiParams extends Omit<BaseApiParams, "provider">, ContractInfo {
    chain: ChainOrRpcUrl;
    localSigner: Signer;
    factoryAddress: string;
    accountAddress?: string;
