import { Celo, CeloAlfajoresTestnet, CeloBaklavaTestnet, Mumbai, Polygon, getChainByChainId } from '@thirdweb-dev/chains';
...
import { getPolygonGasPriorityFee, ThirdwebSDK, LOCAL_NODE_PKEY, getChainProvider } from '@thirdweb-dev/sdk';
  ...
  async createUnsignedUserOp(info, batched) {
    ...
    if (!maxFeePerGas || !maxPriorityFeePerGas) {
      ...
      if (!maxFeePerGas) {
        ...
        if (maxPriorityFeePerGas && (chainId === Mumbai.chainId || chainId === Polygon.chainId)) {
