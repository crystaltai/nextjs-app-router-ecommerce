...
function useChainId() {
  const context = react.useContext(ThirdwebConnectedWalletContext);
  invariant__default["default"](context, "useChainId() hook must be used within a <ThirdwebProvider/>");
...
function useSigner() {
  const context = react.useContext(ThirdwebConnectedWalletContext);
  invariant__default["default"](context, "useSigner() hook must be used within a <ThirdwebProvider/>");
  return context.signer;
}
