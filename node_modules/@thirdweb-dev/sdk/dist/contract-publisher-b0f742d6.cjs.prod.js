...
var IAccountFactory = require('@thirdweb-dev/contracts-js/dist/abis/IAccountFactory.json');
...
var IAccountFactory__default = /*#__PURE__*/_interopDefault(IAccountFactory);
...
function getProviderFromRpcUrl(rpcUrl, sdkOptions, chainId) {
  try {
    ...
    if (isTwUrl(rpcUrl)) {
      ...
      headers["x-sdk-platform"] = bundleId ? "react-native" : storage.isBrowser() ? "browser" : "node";
    }
...
const FEATURE_ACCOUNT_FACTORY = {
  ...
  abis: [IAccountFactory__default["default"]],
  features: {}
};
...
async function resolveImplementationBytecode(address, provider) {
  ...
  try {
    ...
    if (ethers.utils.isAddress(implementationAddress) && implementationAddress !== ethers.constants.AddressZero) {
      return await resolveImplementationBytecode(implementationAddress, provider);
    }
  } catch (e) {
    // ignore
...
async function getMetadataUriFromMultichainRegistry(address, chainId, sdkOptions) {
  if (!multichainRegistry) {
    ...
    multichainRegistry = new ethers.Contract(getMultichainRegistryAddress(), TWRegistryABI__default["default"], getChainProvider(chain, sdkOptions));
  }
...
async function getDynamicFeeData(provider) {
  ...
  const [chainId, block, eth_maxPriorityFeePerGas] = await Promise.all([(await provider.getNetwork()).chainId, await provider.getBlock("latest"), await provider.send("eth_maxPriorityFeePerGas", []).catch(() => null)]);
  ...
  if (chainId === chains.Mumbai.chainId || chainId === chains.Polygon.chainId) {
    ...
    console.log("DYNAMIC: polygon fee", ethers.utils.formatUnits(maxPriorityFeePerGas, "gwei"));
...
async function fetchPublishedContractFromPolygon(publisherAddress, contractName) {
  ...
  const contract = new ethers.Contract(getContractPublisherAddress(), ContractPublisherAbi__default["default"], getChainProvider(chain, {
    clientId,
    secretKey
  }));
...
async function biconomySendFunction(transaction, signer, provider, gaslessOptions) {
  ...
  const response = await fetch__default["default"]("https://api.biconomy.io/api/v2/meta-tx/native", request);
  if (response.ok) {
...
async function defenderSendFunction(transaction, signer, provider, storage, gaslessOptions) {
  ...
  const response = await fetch__default["default"](gaslessOptions.openzeppelin.relayerUrl, request);
  if (response.ok) {
    const resp = await response.json();
    if (!resp.result) {
...
async function fetchTokenMetadataForContract(contractAddress, provider, tokenId, storage) {
  ...
  if (isERC721) {
    const erc721 = new ethers.Contract(contractAddress, IERC721MetadataAbi__default["default"], provider);
...
class DelayedReveal {
  ...
  async getLegacyEncryptedData(index) {
    const legacy = new ethers.Contract(this.contractWrapper.readContract.address, DeprecatedAbi__default["default"], this.contractWrapper.getProvider());
...
async function fetchCurrencyMetadata(provider, asset) {
  if (isNativeToken(asset)) {
    ...
    const erc20 = new ethers.Contract(asset, IERC20MetadataAbi__default["default"], provider);
...
async function approveErc20Allowance(contractToApprove, currencyAddress, price, quantity, tokenDecimals) {
  ...
  const erc20 = new ContractWrapper(signer || provider, currencyAddress, ERC20Abi__default["default"], contractToApprove.options, contractToApprove.storage);
...
class DropClaimConditions {
  ...
  async getClaimIneligibilityReasons(quantity, addressToCheck) {
    ...
    const quantityWithDecimals = ethers.utils.parseUnits(QueryParams.AmountSchema.parse(quantity), decimals);
    ...
    if (claimCondition.price.gt(0) && isNode()) {
      ...
      if (isNativeToken(claimCondition.currencyAddress)) {
        ...
        const erc20 = new ContractWrapper(provider, claimCondition.currencyAddress, ERC20Abi__default["default"], {}, this.storage);
...
class Erc721SharedMetadata {
   ...
   */
  set = /* @__PURE__ */buildTransactionFunction(async metadata => {
    const parsedMetadata = QueryParams.BasicNFTInput.parse(metadata);
    // cleanup description
...
async function getPrebuiltInfo(address, provider) {
  try {
    const contract = new ethers.Contract(address, IThirdwebContractABI__default["default"], provider);
...
async function handleTokenApproval(contractWrapper, marketplaceAddress, assetContract, tokenId, from) {
  const erc165 = new ContractWrapper(contractWrapper.getSignerOrProvider(), assetContract, ERC165Abi__default["default"], contractWrapper.options, contractWrapper.storage);
  ...
  if (isERC721) {
    const asset = new ContractWrapper(contractWrapper.getSignerOrProvider(), assetContract, Erc721Abi__default["default"], contractWrapper.options, contractWrapper.storage);
    ...
    const asset = new ContractWrapper(contractWrapper.getSignerOrProvider(), assetContract, Erc1155Abi__default["default"], contractWrapper.options, contractWrapper.storage);
    const approved = await asset.readContract.isApprovedForAll(from, marketplaceAddress);
    if (!approved) {
      await asset.sendTransaction("setApprovalForAll", [marketplaceAddress, true]);
    }
...
class MarketplaceV3Offers {
  ...
  async isStillValidOffer(offer) {
    ...
    const provider = this.contractWrapper.getProvider();
    const erc20 = new ContractWrapper(provider, currency, ERC20Abi__default["default"], {}, this.storage);
...
const EditionDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract, _network] = await Promise.all([EditionDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./edition-drop-17dbca05.cjs.prod.js'); }), provider.getNetwork()]);
...
const EditionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./edition-9844b67f.cjs.prod.js'); }), provider.getNetwork()]);
...
const MarketplaceInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./marketplace-845a5cba.cjs.prod.js'); }), provider.getNetwork()]);
...
const MarketplaceV3Initializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceV3Initializer.getAbi(address, provider, storage, options), Promise.resolve().then(function () { return require('./marketplacev3-f1986ef4.cjs.prod.js'); }), provider.getNetwork()]);
...
const MultiwrapInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./multiwrap-ad258f02.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTCollectionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./nft-collection-c9465814.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./nft-drop-1e8e3422.cjs.prod.js'); }), provider.getNetwork()]);
...
const PackInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./pack-4be3cb47.cjs.prod.js'); }), provider.getNetwork()]);
...
const SignatureDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./signature-drop-03f3047f.cjs.prod.js'); }), provider.getNetwork()]);
...
const SplitInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./split-e1420b09.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./token-drop-e252b24d.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./token-207bd533.cjs.prod.js'); }), provider.getNetwork()]);
...
const VoteInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./vote-14e6035d.cjs.prod.js'); }), provider.getNetwork()]);
...
const SignerPermissionsSchema = /* @__PURE__ */zod.z.object({
  ...
  nativeTokenLimitPerTransaction: /* @__PURE__ */QueryParams.AmountSchema.default(0),
  approvedCallTargets: /* @__PURE__ */zod.z.array(AddressOrEnsSchema)
});
const PermissionSnapshotSchema = /* @__PURE__ */zod.z.array( /* @__PURE__ */zod.z.object({
  signer: AddressOrEnsSchema,
  makeAdmin: /* @__PURE__ */zod.z.boolean(),
...
class ContractPublisher extends RPCConnectionHandler {
  constructor(network, options, storage) {
    super(network, options);
    this.storage = storage;
    this.publisher = new ContractWrapper(network, getContractPublisherAddress(), ContractPublisherAbi__default["default"], options, storage);
  }
  updateSignerOrProvider(network) {
    super.updateSignerOrProvider(network);
...
exports.getCompositePluginABI = getCompositePluginABI;
...
exports.resolveImplementationBytecode = resolveImplementationBytecode;
