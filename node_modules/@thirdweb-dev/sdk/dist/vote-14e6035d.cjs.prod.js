...
class Vote {
  ...
  async hasVoted(proposalId, account) {
    ...
    return this.contractWrapper.readContract.hasVoted(proposalId, await contractPublisher.resolveAddress(account));
  }
  ...
  async balanceOfToken(tokenAddress) {
    ...
    return await contractPublisher.fetchCurrencyValue(this.contractWrapper.getProvider(), tokenAddress, await erc20.balanceOf(this.contractWrapper.readContract.address));
  }
