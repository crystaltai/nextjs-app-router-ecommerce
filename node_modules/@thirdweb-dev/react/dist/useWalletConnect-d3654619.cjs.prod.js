...
var basic = require('./basic-77cdb3c8.cjs.prod.js');
var react = require('@emotion/react');
var styled = require('@emotion/styled');
var RXPopover = require('@radix-ui/react-popover');
var copy = require('copy-to-clipboard');
var Tooltip = require('./Tooltip-6c7b06c2.cjs.prod.js');
        ...
        children: /*#__PURE__*/jsxRuntime.jsxs(DialogContent, {
          ...
          children: [props.title && /*#__PURE__*/jsxRuntime.jsxs(DialogTitle, {
            ...
            children: /*#__PURE__*/jsxRuntime.jsx(Dialog__namespace.Close, {
              asChild: true,
              children: /*#__PURE__*/jsxRuntime.jsx(basic.IconButton, {
                variant: "secondary",
                type: "button",
                "aria-label": "Close",
...
const CrossContainer = styled__default["default"].div`
  ...
  right: ${basic.spacing.lg};

  ${basic.media.mobile} {
    right: ${basic.spacing.md};
  }
`;
...
const DialogContent = styled__default["default"].div`
  ...
  overflow-y: auto;
  padding: ${basic.spacing.lg};
  padding-bottom: ${basic.spacing.xl};
  animation: ${modalAnimationDesktop} 200ms ease;
  box-shadow: ${basic.shadow.lg};
  line-height: 1;
  ...
  ${basic.media.mobile} {
    ...
    border-radius: ${basic.radius.xxl};
...
`;
const DialogTitle = styled__default["default"].h2`
  margin: 0;
  font-weight: 500;
  color: ${p => p.theme.text.neutral};
...
const NetworkSelector = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(react.ThemeProvider, {
    theme: theme === "dark" ? basic.darkTheme : basic.lightTheme,
    children: /*#__PURE__*/jsxRuntime.jsxs(Modal, {
      ...
      style: {
        maxWidth: "480px",
        paddingBottom: props.onCustomClick ? basic.spacing.md : "0px"
      },
      children: [/*#__PURE__*/jsxRuntime.jsx(basic.Spacer, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs(Tabs__namespace.List, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(StyledMagnifyingGlassIcon, {
            ...
            tabIndex: coinbaseWallet.isMobile() ? -1 : 0,
            variant: "secondary",
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(ChainIcon, {
            ...
            children: [chainName, /*#__PURE__*/jsxRuntime.jsxs("div", {
              ...
              children: [confirming && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
                children: [/*#__PURE__*/jsxRuntime.jsx(ConfirmMessage, {
                  children: "Confirm in Wallet"
                }), /*#__PURE__*/jsxRuntime.jsx(basic.Spinner, {
                  size: "sm",
                  color: "link"
                })]
              }), switchingFailed && /*#__PURE__*/jsxRuntime.jsx(ErrorMessage, {
...
const TabButton = styled__default["default"]( Tabs__namespace.Trigger)`
  ...
  color: ${p => p.theme.text.secondary};
  cursor: pointer;
  padding: ${basic.spacing.sm} ${basic.spacing.sm};
...
const ScrollContainer = styled__default["default"].div`
  ...
  overflow: auto;
  padding-right: 10px;
  padding-bottom: ${basic.spacing.lg};
  width: calc(100% + 16px);
...
const StyledMagnifyingGlassIcon = styled__default["default"](reactIcons.MagnifyingGlassIcon)`
  ...
  left: 18px;
`;
const SearchInput = styled__default["default"](basic.Input)`
  padding: ${basic.spacing.sm} ${basic.spacing.md} ${basic.spacing.sm} 60px;
`;
const ConfirmMessage = styled__default["default"].div`
  font-size: ${basic.fontSize.sm};
...
const ConnectedWalletDetails = props => {
  ...
  const trigger = props.detailsBtn ? /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(ChainIcon, {
      ...
      children: [balanceQuery.data ? /*#__PURE__*/jsxRuntime.jsxs(WalletBalance, {
        className: `${TW_CONNECTED_WALLET}__balance`,
        children: [Number(balanceQuery.data.displayValue).toFixed(3), " ", balanceQuery.data.symbol]
      }) : /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.Skeleton, {
        height: basic.fontSize.sm,
        width: "82px"
      }), /*#__PURE__*/jsxRuntime.jsx(basic.Spacer, {
        y: "xs"
      }), activeWallet?.walletId === wallets.walletIds.localWallet ? /*#__PURE__*/jsxRuntime.jsx(basic.ErrorMessage, {
        style: {
          lineHeight: 1,
          minWidth: "70px",
          fontSize: basic.fontSize.xs
        },
        children: "Guest"
      }) : address ? /*#__PURE__*/jsxRuntime.jsx(WalletAddress, {
        className: `${TW_CONNECTED_WALLET}__address`,
        children: shortenString(address || "")
      }) : /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.Skeleton, {
        height: basic.fontSize.xs,
        width: "88px"
      })]
  ...
  const networkSwitcherButton = /*#__PURE__*/jsxRuntime.jsx(Tooltip.ToolTip, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
      ...
      }), chain?.name || `Unknown chain #${walletChainId}`, /*#__PURE__*/jsxRuntime.jsx(StyledChevronRightIcon, {
  ...
  const content = /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsxs(basic.Flex, {
      gap: "md",
      children: [/*#__PURE__*/jsxRuntime.jsx(basic.Img, {
        width: basic.iconSize.xl,
        height: basic.iconSize.xl,
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs(basic.Flex, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsxs(AccountAddress, {
              children: [" ", shortenString(address || "")]
            }), /*#__PURE__*/jsxRuntime.jsx(basic.IconButton, {
              variant: "secondary",
              style: {
                padding: "3px"
              },
            ...
            children: /*#__PURE__*/jsxRuntime.jsx(DisconnectIconButton, {
              ...
              children: /*#__PURE__*/jsxRuntime.jsx(ExitIcon, {
                size: basic.iconSize.md
              })
            })
          })]
        }), /*#__PURE__*/jsxRuntime.jsxs(AccountBalance, {
          children: [" ", balanceQuery.data ? Number(balanceQuery.data.displayValue).toFixed(3) : /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.Skeleton, {
            height: "1em",
            width: "100px"
      ...
      }), activeWalletConfig && activeWalletConfig.id === wallets.walletIds.metamask && activeWalletConfig.isInstalled && activeWalletConfig.isInstalled() && !coinbaseWallet.isMobile() && /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
        type: "button",
        onClick: () => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [coinbaseWallet.isMobile() ? /*#__PURE__*/jsxRuntime.jsx(Modal, {
      trigger: trigger,
      open: open,
      setOpen: setOpen,
      hideCloseIcon: true,
...
const WalletInfoButton = styled__default["default"].button`
  ...
  -webkit-tap-highlight-color: transparent;
  line-height: 1;
  animation: ${coinbaseWallet.fadeInAnimation} 300ms ease;

  ${basic.media.mobile} {
    gap: ${basic.spacing.sm};
    padding: ${basic.spacing.xs} ${basic.spacing.sm};
    img {
      width: ${basic.iconSize.md}px;
      height: ${basic.iconSize.md}px;
    }
  }
...
const StyledChevronRightIcon = styled__default["default"]( reactIcons.ChevronRightIcon)`
  color: ${props => props.theme.text.secondary};
`;
const DisconnectIconButton = styled__default["default"](basic.IconButton)`
  margin-right: -${basic.spacing.xxs};
  margin-left: auto;
...
const SignatureModal = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(Modal, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(Container, {
      children: [walletConfig && /*#__PURE__*/jsxRuntime.jsx(basic.Img, {
        height: basic.iconSize.xl,
...
`;
const Desc = styled__default["default"](coinbaseWallet.ModalDescription)`
  ${basic.media.mobile} {
    max-width: 240px;
    margin: 0 auto;
  }
...
const ConnectWallet = props => {
  ...
  const setIsWalletModalOpen = coinbaseWallet.useSetIsWalletModalOpen();
  const setModalConfig = React.useContext(coinbaseWallet.SetModalConfigCtx);
  const address = reactCore.useAddress();
    ...
    children: [showSignatureModal && /*#__PURE__*/jsxRuntime.jsx(SignatureModal, {
      ...
      if (!activeWallet) {
        ...
        return /*#__PURE__*/jsxRuntime.jsx(AnimatedButton, {
          ...
          children: isLoading ? /*#__PURE__*/jsxRuntime.jsx(basic.Spinner, {
            size: "sm",
            color: "inverted"
          }) : btnTitle
        });
      ...
      // sign in button
        ...
        return /*#__PURE__*/jsxRuntime.jsxs(basic.Button, {
          variant: "inverted",
          onClick: signIn,
          "data-theme": theme,
          ...
          children: [/*#__PURE__*/jsxRuntime.jsxs(basic.Flex, {
            ...
            gap: "sm",
            style: {
              paddingRight: basic.spacing.xs,
              borderRight: "1px solid",
              marginRight: basic.spacing.xs
            },
...
function SwitchNetworkButton(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(AnimatedButton, {
    ...
    children: switching ? /*#__PURE__*/jsxRuntime.jsx(basic.Spinner, {
      size: "sm",
      color: "inverted"
    }) : "Switch Network"
  });
}
const AnimatedButton = styled__default["default"](basic.Button)`
  animation: ${coinbaseWallet.fadeInAnimation} 300ms ease;
`;
...
const ConnectModalContent = props => {
  ...
  const modalConfig = React.useContext(coinbaseWallet.ModalConfigCtx);
  ...
  const isWalletModalOpen = coinbaseWallet.useIsWalletModalOpen();
  const setIsWalletModalOpen = coinbaseWallet.useSetIsWalletModalOpen();
  const connectionStatus = reactCore.useConnectionStatus();
  const wallet = reactCore.useWallet();
  const walletModalConfig = React.useContext(coinbaseWallet.ModalConfigCtx);
  const setWalletModalConfig = React.useContext(coinbaseWallet.SetModalConfigCtx);
  const disconnect = reactCore.useDisconnect();
  ...
  const WalletConnectUI = typeof screen !== "string" && (screen.connectUI || coinbaseWallet.HeadlessConnectUI);
  return /*#__PURE__*/jsxRuntime.jsxs(react.ThemeProvider, {
    theme: typeof theme === "object" ? theme : theme === "light" ? basic.lightTheme : basic.darkTheme,
    children: [screen === reservedScreens.main && /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.WalletSelector, {
      title: title,
    ...
    }), screen === reservedScreens.getStarted && /*#__PURE__*/jsxRuntime.jsx(GetStartedWithWallets, {
      onBack: handleBack
    }), WalletConnectUI && /*#__PURE__*/jsxRuntime.jsx(WalletConnectUI, {
...
const ConnectModal = () => {
  const {
    theme
  } = React.useContext(coinbaseWallet.ModalConfigCtx);
  const {
    screen,
    setScreen,
    initialScreen
  ...
  const disconnect = reactCore.useDisconnect();
  return /*#__PURE__*/jsxRuntime.jsx(react.ThemeProvider, {
    theme: theme === "light" ? basic.lightTheme : basic.darkTheme,
...
const ConnectModalInline = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.WalletUIStatesProvider, {
    theme: props.theme,
    children: /*#__PURE__*/jsxRuntime.jsx(react.ThemeProvider, {
      theme: props.theme === "light" ? basic.lightTheme : basic.darkTheme,
      children: /*#__PURE__*/jsxRuntime.jsx(ConnectModalInlineContainer, {
        className: props.className,
        children: /*#__PURE__*/jsxRuntime.jsx(ConnectModalContent, {
          screen: screen,
          setScreen: setScreen,
...
const ModelViewer = /* @__PURE__ */React.lazy(() => Promise.resolve().then(function () { return require('./ModelViewer-0009ff2f.cjs.prod.js'); }));
...
const Web3Button = _ref => {
  ...
  if (hasMismatch && !isDisabled) {
    const _button = /*#__PURE__*/jsxRuntime.jsx(basic.Button, {
      variant: "inverted",
      type: type,
      ...
      "data-theme": theme,
      children: confirmStatus === "waiting" ? /*#__PURE__*/jsxRuntime.jsx(basic.Spinner, {
        size: "sm",
        color: "inverted"
      }) : "Switch Network"
    });
  ...
  // Disabled Loading Spinner Button
    ...
    button = /*#__PURE__*/jsxRuntime.jsx(basic.Button, {
      variant: "inverted",
      type: type,
  ...
  return /*#__PURE__*/jsxRuntime.jsx(react.ThemeProvider, {
    theme: themeToUse === "dark" ? basic.darkTheme : basic.lightTheme,
    children: button
  });
};
...
function useInstalledWallets() {
  ...
  if (wallets.assertWindowEthereum(window_)) {
    ...
    isCoinbaseWalletInstalled = !!window_.ethereum?.isCoinbaseWallet || !!window_.ethereum?.providers?.some(p => p.isCoinbaseWallet);
...
function useRainbowWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await Promise.resolve().then(function () { return require('./RainbowWallet-4c1c94fa.cjs.prod.js'); });
...
function useTrustWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      trustWallet
    } = await Promise.resolve().then(function () { return require('./TrustWallet-d0ec5e75.cjs.prod.js'); }).then(function (n) { return n.TrustWallet; });
...
function useMetamask() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-a66a48c5.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-a66a48c5.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-25fb2f6a.cjs.prod.js'); });
...
function useBloctoWallet() {
  ...
  return React.useCallback(async options => {
    const {
      bloctoWallet
    } = await Promise.resolve().then(function () { return require('./bloctoWallet-4d2c89f8.cjs.prod.js'); });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-abf8898e.cjs.prod.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./walletConnectV1-5b27c34e.cjs.prod.js'); });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-a66a48c5.cjs.prod.js'); }).then(function (n) { return n.walletConnect$1; });
