import { L as Label, S as Spacer, c as Input, E as ErrorMessage, d as InputContainer, e as InputButton, f as fontSize, m as media, g as IconButton, i as iconSize, s as spacing, I as Img, b as Spinner, r as radius, h as shadow, a as Flex, B as Button } from './basic-344e3cc9.browser.esm.js';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import { CoinbaseWallet, assertWindowEthereum, MetaMaskWallet, getInjectedMetamaskProvider, WalletConnect, walletIds } from '@thirdweb-dev/wallets';
import { useCreateWalletInstance, useWalletContext, useConnect, useSetConnectionStatus, useSetConnectedWallet, useWallet } from '@thirdweb-dev/react-core';
...
const GetStartedScreen = _ref => {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(BackButton, {
    ...
    }), showScreen === "android-scan" && googlePlayStoreLink && /*#__PURE__*/jsx(ScanScreen$1, {
    ...
    }), showScreen === "ios-scan" && appleStoreLink && /*#__PURE__*/jsx(ScanScreen$1, {
      platformIcon: /*#__PURE__*/jsx(Img, {
        width: iconSize.md,
        height: iconSize.md,
        src: Apple
      ...
      children: [/*#__PURE__*/jsx(Spacer, {
        ...
        children: ["I", `'`, "ve finished setting up my ", walletName, " on mobile"]
      })]
    }), !isScanScreen && footer]
  });
};
  ...
  return {
    ...
    isInstalled() {
      ...
      if (assertWindowEthereum(window_)) {
        return window_.ethereum?.isCoinbaseWallet || window_.ethereum?.providers?.some(p => p.isCoinbaseWallet) || false;
      }
      return false;
    }
  };
...
const defaultWallets = /* @__PURE__ */(() => [metamaskWallet(), coinbaseWallet(), walletConnect()])();
...
const WalletSelection = props => {
  ...
  return /*#__PURE__*/jsx(WalletListContainer, {
...
export { BackButton as B, ConnectingScreen as C, FormFieldWithIconButton as F, GetStartedScreen as G, HelperLink as H, ModalTitle as M, ScanScreen as S, WalletSelection as W, ModalDescription as a, HeadlessConnectUI as b, coinbaseWallet as c, defaultWallets as d, useIsWalletModalOpen as e, useSetIsWalletModalOpen as f, ButtonLink as g, FormField as h, isMobile as i, isAndroid as j, isIOS as k, fadeInAnimation as l, metamaskWallet as m, Skeleton as n, openWindow as o, SetModalConfigCtx as p, WalletUIStatesProvider as q, ModalConfigCtx as r, WalletSelector as s, coinbaseWallet$1 as t, useIsHeadlessWallet as u, metamaskWallet$1 as v, walletConnect as w, walletConnect$1 as x };
