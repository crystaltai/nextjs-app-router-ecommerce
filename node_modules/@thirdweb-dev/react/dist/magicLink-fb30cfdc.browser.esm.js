...
import { B as Button, s as spacing, f as fontSize, a as Flex, b as Spinner, S as Spacer, g as IconButton, I as Img, i as iconSize } from './basic-344e3cc9.browser.esm.js';
import { I as InputSelectionUI } from './InputSelectionUI-7377db6b.browser.esm.js';
...
function magicLink(config) {
  const selectUI = props => /*#__PURE__*/jsx(MagicSelectionUI, {
    ...props,
  ...
  return {
    ...
    connectUI(props) {
      return /*#__PURE__*/jsx(MagicConnectionUI, {
        ...props,
...
const MagicSelectionUI = props => {
  ...
  return /*#__PURE__*/jsx(Fragment, {
    children: /*#__PURE__*/jsx(InputSelectionUI, {
      ...
      footer: props.oauthProviders && /*#__PURE__*/jsxs(Fragment, {
        children: [!noInput && /*#__PURE__*/jsx(Spacer, {
          y: "lg"
        }), props.oauthProviders.length >= 3 ? /*#__PURE__*/jsx(Flex, {
          gap: "md",
