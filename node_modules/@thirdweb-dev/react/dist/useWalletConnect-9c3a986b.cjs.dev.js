...
var Tooltip = require('./Tooltip-b037f5cd.cjs.dev.js');
var reactIcons = require('@radix-ui/react-icons');
var coinbaseWallet = require('./headlessConnectUI-dd4f0e3f.cjs.dev.js');
...
function useRainbowWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await Promise.resolve().then(function () { return require('./RainbowWallet-44018918.cjs.dev.js'); });
...
function useTrustWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      trustWallet
    } = await Promise.resolve().then(function () { return require('./TrustWallet-c0ff679d.cjs.dev.js'); }).then(function (n) { return n.TrustWallet; });
...
function useMetamask() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-dd4f0e3f.cjs.dev.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-dd4f0e3f.cjs.dev.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-4850d2e0.cjs.dev.js'); });
...
function useBloctoWallet() {
  ...
  return React.useCallback(async options => {
    const {
      bloctoWallet
    } = await Promise.resolve().then(function () { return require('./bloctoWallet-9b4885f2.cjs.dev.js'); });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-2b5cc92d.cjs.dev.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./walletConnectV1-498847f4.cjs.dev.js'); });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-dd4f0e3f.cjs.dev.js'); }).then(function (n) { return n.walletConnect$1; });
