...
const GetStartedScreen = _ref => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    ...
    }), showScreen === "android-scan" && googlePlayStoreLink && /*#__PURE__*/jsxRuntime.jsx(ScanScreen$1, {
    ...
    }), showScreen === "ios-scan" && appleStoreLink && /*#__PURE__*/jsxRuntime.jsx(ScanScreen$1, {
      platformIcon: /*#__PURE__*/jsxRuntime.jsx(basic.Img, {
        width: basic.iconSize.md,
        height: basic.iconSize.md,
        src: Apple
...
const WalletSelection = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(WalletListContainer, {
...
const WalletListContainer = styled__default["default"].ul`
  all: unset;
